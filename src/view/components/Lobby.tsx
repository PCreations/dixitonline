...
import type { LobbyViewModel, LobbyAction } from "../view-models/lobby.view-model.js";
...
/**
 * Pure component - renders ViewModel, NO logic
 */
...
function LobbyActionButton({ action }: { action: LobbyAction }) {
  ...
  // copy-invite or other actions rendered differently if needed
  return null;
}
