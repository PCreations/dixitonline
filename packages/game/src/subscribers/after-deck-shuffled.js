...
export const makeAfterDeckShuffledSubscriber = async ({ subscribeToDomainEvent, completeHands, uuid = uuidv4 }) => {
  await subscribeToDomainEvent(deckEvents.types.DECK_SHUFFLED, async deckShuffledEvent => {
